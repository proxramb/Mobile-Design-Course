...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "ZgWnxPVP5lSNNDx4cvNNMniZz", consumerSecret: "2mIj42t2eZcELwRc0yvFiHCwsHafdyM9uilEWqnq0OCyBMVs4d")
    var loginSuccess: (() -> ())?
